...
namespace FiiiChain.Messages
{
    public class P2PCommand
    {
        ...
        public static P2PCommand CreateCommand(string commandName, BasePayload payload)
        {
        ...
        public static P2PCommand CreateCommand(string commandName, int nonce, BasePayload payload)
        {
            var command = new P2PCommand();
            command.Prefix = DefaultPrefixBytes;
            command.Suffix = DefaultSuffixBytes;
        ...
        public static P2PCommand ConvertBytesToMessage(byte[] bytes)
        {
            ...
            Array.Copy(bytes, 16, nonceBytes, 0, 4);
            Array.Copy(bytes, 20, sizeBytes, 0, 4);
            ...
            Array.Copy(bytes, 24, payloadBytes, 0, size);
            Array.Copy(bytes, 24 + size, checksumBytes, 0, 4);

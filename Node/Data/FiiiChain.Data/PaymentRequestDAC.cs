...
{
    public class PaymentRequestDac : DataAccessComponent
    {
        public long Insert(PaymentRequest request)
        {
        ...
        public List<PaymentRequest> SelectAll()
        {
            const string SQL_STATEMENT =
                "SELECT * " +
        ...
        public PaymentRequest SelectById(long id)
        {
            const string SQL_STATEMENT =
                "SELECT * " +
                "FROM PaymentRequests " +
